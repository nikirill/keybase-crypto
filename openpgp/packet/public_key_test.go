...
func Test64bitExponents(t *testing.T) {
	rsaPacket := bytes.NewBuffer(nil)
	N, _ := new(big.Int).SetString("", 10)
	e, _ := new(big.Int).SetString("3100929515", 10)
	writeMPI(rsaPacket, uint16(N.BitLen()), N.Bytes())
	writeMPI(rsaPacket, uint16(e.BitLen()), e.Bytes())
	pk := PublicKey{}
	err := pk.parseRSA(rsaPacket)
	if err != nil {
		t.Fatal(err)
	}

	rsaPublicKey := pk.PublicKey.(*rsa.PublicKey)
	if rsaPublicKey.E != int64(3100929515) {
		t.Fatal("Failed to read exponent properly")
	}

	rsaSig, _ := hex.DecodeString(``)
	hashBytes, _ := hex.DecodeString("e2f9181ee361b902edc112cf5bcb8bac2ae24e79dd15158de42cb8424a82c325")

	err = rsa.VerifyPKCS1v15(rsaPublicKey, crypto.SHA256, hashBytes, padToKeySize(rsaPublicKey, rsaSig))
	if err != nil {
		t.Fatalf("Failed to VerifyPKCS1v15: %s", err)
	}
}
